...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___vol'
  | 'childMarkdownRemark___frontmatter___author'
  | 'childMarkdownRemark___frontmatter___profile'
...
export type FrontmatterFilterInput = {
  ...
  vol?: Maybe<StringQueryOperatorInput>;
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___twitter___handle'
  | 'pluginCreator___pluginOptions___twitter___site'
  | 'pluginCreator___pluginOptions___twitter___cardType'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___twitter___handle'
  | 'pluginOptions___twitter___site'
  | 'pluginOptions___twitter___cardType'
...
export type ErrorPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type IndexPageQuery = { allMarkdownRemark: { nodes: Array<(
      ...
      & { fields?: Maybe<Pick<Fields, 'slug'>>, frontmatter?: Maybe<Pick<Frontmatter, 'date' | 'title' | 'vol' | 'description'>> }
    )> } };
