...
type SitePageContext = {
  ...
  readonly previousArtworkId: Maybe<Scalars['String']>;
  readonly nextArtworkId: Maybe<Scalars['String']>;
};
...
type SitePageContextFilterInput = {
  ...
  readonly previousArtworkId: Maybe<StringQueryOperatorInput>;
  readonly nextArtworkId: Maybe<StringQueryOperatorInput>;
};
...
enum SitePageFieldsEnum {
  ...
  context___vol = 'context.vol',
  context___artist = 'context.artist',
  context___previousArtworkId = 'context.previousArtworkId',
  context___nextArtworkId = 'context.nextArtworkId',
  ...
  pluginCreator___pluginOptions___image___width = 'pluginCreator.pluginOptions.image.width',
  pluginCreator___pluginOptions___image___height = 'pluginCreator.pluginOptions.image.height',
  pluginCreator___pluginOptions___image___backgroundColor = 'pluginCreator.pluginOptions.image.backgroundColor',
  pluginCreator___pluginOptions___fontFile = 'pluginCreator.pluginOptions.fontFile',
  pluginCreator___pluginOptions___fontFile___path = 'pluginCreator.pluginOptions.fontFile.path',
  pluginCreator___pluginOptions___fontFile___family = 'pluginCreator.pluginOptions.fontFile.family',
  pluginCreator___pluginOptions___fontFile___weight = 'pluginCreator.pluginOptions.fontFile.weight',
  pluginCreator___pluginOptions___iconFile = 'pluginCreator.pluginOptions.iconFile',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___fontFile = 'pluginOptions.plugins.pluginOptions.fontFile',
  pluginOptions___plugins___pluginOptions___iconFile = 'pluginOptions.plugins.pluginOptions.iconFile',
  pluginOptions___plugins___pluginOptions___timeout = 'pluginOptions.plugins.pluginOptions.timeout',
  ...
  pluginOptions___image___width = 'pluginOptions.image.width',
  pluginOptions___image___height = 'pluginOptions.image.height',
  pluginOptions___image___backgroundColor = 'pluginOptions.image.backgroundColor',
  pluginOptions___style___title___fontFamily = 'pluginOptions.style.title.fontFamily',
  pluginOptions___style___title___fontColor = 'pluginOptions.style.title.fontColor',
  pluginOptions___style___title___fontWeight = 'pluginOptions.style.title.fontWeight',
  pluginOptions___style___title___fontSize = 'pluginOptions.style.title.fontSize',
  pluginOptions___style___title___paddingTop = 'pluginOptions.style.title.paddingTop',
  pluginOptions___style___title___paddingBottom = 'pluginOptions.style.title.paddingBottom',
  pluginOptions___style___title___paddingLeft = 'pluginOptions.style.title.paddingLeft',
  pluginOptions___style___title___paddingRight = 'pluginOptions.style.title.paddingRight',
  pluginOptions___style___author___fontFamily = 'pluginOptions.style.author.fontFamily',
  pluginOptions___style___author___fontColor = 'pluginOptions.style.author.fontColor',
  pluginOptions___style___author___fontWeight = 'pluginOptions.style.author.fontWeight',
  pluginOptions___style___author___fontSize = 'pluginOptions.style.author.fontSize',
  pluginOptions___fontFile = 'pluginOptions.fontFile',
  pluginOptions___fontFile___path = 'pluginOptions.fontFile.path',
  pluginOptions___fontFile___family = 'pluginOptions.fontFile.family',
  pluginOptions___fontFile___weight = 'pluginOptions.fontFile.weight',
  pluginOptions___iconFile = 'pluginOptions.iconFile',
...
type SitePluginPluginOptions = {
  ...
  readonly fontFile: Maybe<ReadonlyArray<Maybe<SitePluginPluginOptionsFontFile>>>;
...
type SitePluginPluginOptionsPluginsPluginOptions = {
  ...
  readonly fontFile: Maybe<ReadonlyArray<Maybe<SitePluginPluginOptionsPluginsPluginOptionsFontFile>>>;
  readonly iconFile: Maybe<Scalars['String']>;
  readonly timeout: Maybe<Scalars['Int']>;
  readonly maxWidth: Maybe<Scalars['Int']>;
  readonly linkImagesToOriginal: Maybe<Scalars['Boolean']>;
...
type VerticalArticleBySlugQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
    & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'author' | 'profile' | 'vol'>> }
  )>, readonly previous: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'vol'>> }>, readonly next: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'vol'>> }> };
...
type HorizontalArticleBySlugQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
    & { readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'author' | 'profile' | 'description'>> }
  )>, readonly previous: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'vol'>> }>, readonly next: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'vol'>> }> };

type VolPageQueryVariables = Exact<{
  vol: Scalars['String'];
}>;


type VolPageQuery = { readonly posts: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
      & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'author' | 'vol'>> }
    )> }, readonly artworks: { readonly edges: ReadonlyArray<{ readonly node: Pick<Directory, 'id' | 'name'> }> } };

type ImageGalleryBySlugQueryVariables = Exact<{
  id: Scalars['String'];
  artist: Scalars['String'];
  previousArtworkId: Maybe<Scalars['String']>;
  nextArtworkId: Maybe<Scalars['String']>;
}>;


type ImageGalleryBySlugQuery = { readonly artworks: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'name' | 'id'>
        & { readonly childImageSharp: Maybe<Pick<ImageSharp, 'id' | 'gatsbyImageData'>> }
      ) }> }, readonly previous: Maybe<Pick<Directory, 'id' | 'name'>>, readonly next: Maybe<Pick<Directory, 'id' | 'name'>>, readonly artist: Maybe<Pick<Directory, 'id' | 'name'>> };
...
type IndexPageQuery = { readonly home: Maybe<Pick<PagesJson, 'image' | 'catchphrase' | 'introduction'>>, readonly genki: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
